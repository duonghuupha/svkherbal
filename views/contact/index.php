            ...
            <div class="container">
                ...
                <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post">
                    <div class="row row-20 row-md-30">
                            ...
                            <div class="row row-20 row-md-30">
                                <div class="col-sm-6">
                                    <div class="form-wrap">
                                        ...
                                        <label class="form-label" for="contact-first-name-2">Họ và tên đệm</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-wrap">
                        ...
                        <div class="col-lg-4">
                            <div class="form-wrap">
                                <label class="form-label" for="contact-message-2">Nội dung</label>
                                <textarea class="form-input textarea-lg" id="contact-message-2" name="message" data-constraints="@Required"></textarea>
                            </div>
                        </div>
                    </div>
                    <button class="button button-lg button-secondary button-zakaria" type="submit">Gửi liên hệ</button>
                </form>
            </div>
        </section>
        <!-- Get in touch-->
                ...
                <div class="row row-30 justify-content-center">
                    <div class="col-sm-6 col-md-4">
                        ...
                        <ul class="contacts-classic">
                            <li>Văn phòng <a href="tel:#">+84 (28) 730 222 66</a></li>
                            <li>Hotline <a href="tel:#">+84 (09) 154 6060</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <h4>Địa chỉ</h4>
                        <div class="contacts-classic">
                            <a href="#">1D/16 Bình Giã, Phường 13 <br>Quận Tân Bình, Thành phố Hồ Chí Minh</a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <h4>E-mail</h4>
                        <ul class="contacts-classic">
                            <li><a href="mailTo:#">svkherbal@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
